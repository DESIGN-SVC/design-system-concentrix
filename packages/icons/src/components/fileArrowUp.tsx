...
export const FileArrowUp = ({ ...props }: GenericIconProps) => (
    <svg
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M9.622 1.569a.5.5 0 01.5.5V5.36h3.292a.5.5 0 010 1H9.622a.5.5 0 01-.5-.5V2.069a.5.5 0 01.5-.5zM7.644 7.674a.5.5 0 01.707 0l1.896 1.896a.5.5 0 01-.707.707L7.997 8.734l-1.542 1.543a.5.5 0 11-.707-.707l1.896-1.896z"
        fill="currentColor"
      />
      <path
        fillRule="evenodd"
