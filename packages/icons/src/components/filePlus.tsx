...
export const FilePlus = ({ ...props }: GenericIconProps) => (
    <svg
    ...
    >
        ...
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M9.622 1.569a.5.5 0 01.5.5V5.36h3.292a.5.5 0 010 1H9.622a.5.5 0 01-.5-.5V2.069a.5.5 0 01.5-.5zM5.872 10.194a.5.5 0 01.5-.5h3.25a.5.5 0 110 1h-3.25a.5.5 0 01-.5-.5z"
            fill="currentColor"
        />
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M7.997 8.069a.5.5 0 01.5.5v3.25a.5.5 0 11-1 0v-3.25a.5.5 0 01.5-.5z"
            fill="currentColor"
        />
    </svg>
);
