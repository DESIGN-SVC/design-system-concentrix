...
export const FileText = ({ ...props }: GenericIconProps) => (
    <svg
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M9.622 1.569a.5.5 0 01.5.5V5.36h3.292a.5.5 0 010 1H9.622a.5.5 0 01-.5-.5V2.069a.5.5 0 01.5-.5zM5.331 9.11a.5.5 0 01.5-.5h4.333a.5.5 0 010 1H5.831a.5.5 0 01-.5-.5zM5.331 11.277a.5.5 0 01.5-.5h4.333a.5.5 0 010 1H5.831a.5.5 0 01-.5-.5z"
        fill="currentColor"
      />
    </svg>
);
